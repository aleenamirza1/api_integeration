...
import 'package:api_integration/views/about/about_view.dart' as _i3;
import 'package:api_integration/views/contact/contact_view.dart' as _i4;
import 'package:api_integration/views/description/desc_view.dart' as _i5;
import 'package:api_integration/views/home/home_view.dart' as _i2;
...
class Routes {
  ...
  static const descView = '/desc-view';
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i5.DescView: (data) {
      return _i6.MaterialPageRoute<dynamic>(
        builder: (context) => const _i5.DescView(),
        settings: data,
      );
    },
  };
...
extension NavigatorStateExtension on _i7.NavigationService {
  ...
  Future<dynamic> navigateToDescView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.descView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithDescView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return replaceWith<dynamic>(Routes.descView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
